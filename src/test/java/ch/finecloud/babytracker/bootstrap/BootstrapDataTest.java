...
@DataJpaTest
@Import({UserCsvServiceImpl.class, BabyCsvServiceImpl.class, EventCsvServiceImpl.class, TestConfig.class})
class BootstrapDataTest {
    ...
    @BeforeEach
    void setUp() {
        bootstrapData = new BootstrapData(userAccountRepository, babyRepository, eventRepository, babyCsvService, userCsvService, eventCsvService, passwordEncoder);
    }
    ...
    void Testrun() throws Exception {
        ...
        assertThat(babyRepository.count()).isEqualTo(1);
        assertThat(eventRepository.count()).isEqualTo(55);
    }
